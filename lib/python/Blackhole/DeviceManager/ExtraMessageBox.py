...
def MessageBoxEntry(name, picture):
    pixmap = LoadPixmap('/usr/lib/enigma2/python/Blackhole/DeviceManager/DeviceManager/icons/' + picture)
    if not pixmap:
        pixmap = LoadPixmap('/usr/lib/enigma2/python/Blackhole/DeviceManager/DeviceManager/icons/empty.png')
    return (pixmap, name)
